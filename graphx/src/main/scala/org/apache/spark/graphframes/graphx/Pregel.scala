...
import org.apache.spark.graphframes.graphx.util.PeriodicGraphCheckpointer
...
object Pregel extends Logging {
  ...
  def apply[VD: ClassTag, ED: ClassTag, A: ClassTag](
    ...
    val checkpointInterval =
      graph.vertices.sparkContext.getConf.getInt("spark.graphx.pregel.checkpointInterval", -1)
