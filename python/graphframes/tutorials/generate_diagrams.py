...
pagerank_iterations = """
graph LR
    A0["A: PR=0.25<br/>out=2"] -->|"0.125"| B0["B: PR=0.25<br/>out=1"]
    A0 -->|"0.125"| C0["C: PR=0.25<br/>out=1"]
    B0 -->|"0.250"| C0
    C0 -->|"0.250"| D0["D: PR=0.25<br/>out=0"]

    A1["A: PR=0.04"] -->|"0.02"| B1["B: PR=0.14"]
    A1 -->|"0.02"| C1["C: PR=0.36"]
    B1 -->|"0.14"| C1
    C1 -->|"0.36"| D1["D: PR=0.25"]
"""
