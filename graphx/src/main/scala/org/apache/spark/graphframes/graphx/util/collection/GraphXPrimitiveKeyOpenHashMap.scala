 ...
 * and updates, but not deletions. This map is about an order of magnitude faster than
...
private[graphx] class GraphXPrimitiveKeyOpenHashMap[
  ...
  /**
   * Allocate an OpenHashMap with a default initial capacity, providing a true no-argument
   * constructor.
   */
  def this() = this(64)
