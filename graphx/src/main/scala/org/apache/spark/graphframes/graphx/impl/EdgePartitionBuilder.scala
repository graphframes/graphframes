...
/**
 * Constructs an EdgePartition from an existing EdgePartition with the same vertex set. This
 * enables reuse of the local vertex ids. Intended for internal use in EdgePartition only.
 */
