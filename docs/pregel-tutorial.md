...
description: GraphFrames GRAPHFRAMES_VERSION Pregel and AggregateMessages API Tutorial - HOWTO scale up graph algorithms using bulk syncrhonous parallel APIs.
---
...
<h2 id="inDegree">In-Degree with AggreagateMessages</h2>
...
<h2 id="pagerank">Implementing PageRank with Pregel</h2>
...
<h3>Comparing with GraphFrames' Built-in PageRank</h3>
...
<h2 id="label-propagation">Label Propagation with Pregel</h2>
...
# Run Label Propagation using Pregel
...
# Weighted PageRank based on node type

# Questions contribute more to PageRank than answers
...
<h2 id="pregel-vs-aggregatemessages">Pregel vs AggregateMessages</h2>
