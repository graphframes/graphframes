...
* [Data Setup Tutorial](/03-tutorials/02-data-setup.md): Set up the Stack Exchange dataset used by the Motif Finding and Pregel tutorials. Download the data dump, install dependencies, and convert XML to Parquet.

* [Motif Finding Tutorial](/03-tutorials/03-motif-tutorial.md): Learn how to perform pattern recognition in graphs using network motif finding. This tutorial demonstrates the technique using the `stackexchange.com` knowledge graph, showing you how to identify and analyze recurring patterns and substructures within the graph data.
